 ...
 */
final class Version20221030210209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directory (id BINARY(16) COMMENT \'(DC2Type:uuid)\' NOT NULL, customer_id BINARY(16) COMMENT \'(DC2Type:uuid)\' NOT NULL, contact_id BINARY(16) COMMENT \'(DC2Type:uuid)\' NOT NULL, INDEX IDX_467844DA9395C3F3 (customer_id), INDEX IDX_467844DAE7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
